# ------------------
# Code for a Multinomial Logit Model in WTP-sapce
# 
# Jeff Keller
#
# ------------------
...
setwd("C:/Work/Code/HB/Examples/Basic Example - WTP Space")          	    # working directory
...
choicedata <- read.table("simulated_choicedata_wtpspace.csv",sep=",",header=T)
